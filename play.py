...
# GTTT = game.Game(n=10, target=5, DEBUG_STATE=None, DEBUG_PRINT=False)                             # Initialize n and target
# GTTT.play_game(game_type="PvAI", agents=[[heuristics_alpha_beta_pruning]], first_player="O")
# GTTT.play_game_API(agent=heuristics_alpha_beta_pruning, gameid=gameid)
